...
API_ID = int(getenv("API_ID", "19677870"))
API_HASH = getenv("API_HASH", "dea5dc245192272aea1f1bd05fa137af")
BOT_TOKEN = getenv("BOT_TOKEN", None)
OWNER_ID = int(getenv("OWNER_ID", "6795017446"))
MONGO_URL = getenv("MONGO_URL", None)
SUPPORT_GRP = getenv("SUPPORT_GRP", "Hindichathouse")
UPDATE_CHNL = getenv("UPDATE_CHNL", "RomeoLogo")
OWNER_USERNAME = getenv("OWNER_USERNAME", "ItsRomeo4u")
